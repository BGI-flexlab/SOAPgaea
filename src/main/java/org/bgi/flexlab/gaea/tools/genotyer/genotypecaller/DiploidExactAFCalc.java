...
public abstract class DiploidExactAFCalc extends ExactAFCalc {
    ...
    protected AFCalcResult computeLog10PNonRef(final VariantContext vc,
        ...
        /*System.out.print("log10AlleleFrequencyPriors:");
        for(int i = 0 ; i < log10AlleleFrequencyPriors.length;i++)
        	System.out.print(" "+log10AlleleFrequencyPriors[i]);
        System.out.println();*/
    ...
    protected VariantContext reduceScope(final VariantContext vc) {
        ...
        if ( vc.getAlternateAlleles().size() > getMaxAltAlleles() ) {
            ...
            builder.genotypes(GaeaVariantContextUtils.subsetDiploidAlleles(vc, alleles, false));
            return builder.make();
        } else {
            return vc;
        }
    ...
    private void computeLofK(final ExactACset set,
        ...
        if ( totalK == 0 ) {
            ...
            //System.out.println(getStateTracker());
    ...
    public GenotypesContext subsetAlleles(final VariantContext vc,
                                          ...
                                          final int ploidy) {
        return GaeaVariantContextUtils.subsetDiploidAlleles(vc, allelesToUse, assignGenotypes);
    }
}
