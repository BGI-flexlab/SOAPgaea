...
import org.bgi.flexlab.gaea.tools.vcfstats.report.SampleVCFReport;
...
public class VCFStatsMapper extends Mapper<LongWritable, VariantContextWritable, NullWritable, Text> {
    ...
    protected void cleanup(Context context) throws IOException, InterruptedException {
        for(String sample: vcfReport.getSampleVCFReports().keySet()){
            SampleVCFReport sampleVCFReport = vcfReport.getSampleVCFReports().get(sample);
