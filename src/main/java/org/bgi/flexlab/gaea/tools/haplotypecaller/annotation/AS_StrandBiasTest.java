...
public abstract class AS_StrandBiasTest extends StrandBiasTest implements ReducibleAnnotation {
    ...
    @Override
    public String getRawKeyName() { return GaeaVCFConstants.AS_SB_TABLE_KEY; }
    ...
    private void updateTable(final Allele bestAllele, final GaeaSamRecord read, final Allele ref, final List<Allele> allAlts, final ReducibleAnnotationData<List<Integer>> perAlleleValues) {
        ...
        final boolean isForward = !read.getReadNegativeStrandFlag();
        if (isForward) {
