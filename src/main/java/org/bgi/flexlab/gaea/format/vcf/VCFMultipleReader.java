package org.bgi.flexlab.gaea.format.vcf;
...
import org.bgi.flexlab.gaea.format.vcf.header.GaeaMultipleVCFHeader;
...
public class VCFMultipleReader extends RecordReader<IntWritable, Text> {
	...
	private void getPos(CompressionCodec codec, FSDataInputStream fileIn, Configuration job) throws IOException{
